...
const MyArticles = () => {
  ...
  const confirmPublish = async () => {
    ...
    try {
      ...
      message.success(t('messages.articlePublishedSuccessfully'));
      ...
      message.error(t('myArticles.failedToPublishArticle'));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <p className="text-blue-100 text-lg mt-2">{t('myArticles.subtitle')}</p>
            </div>
            <button 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 text-center">
            ...
            <div className="text-slate-600 font-medium">{t('myArticles.totalArticles')}</div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 text-center">
            ...
            <div className="text-slate-600 font-medium">{t('myArticles.publishedCount')}</div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 text-center">
            ...
            <div className="text-slate-600 font-medium">{t('myArticles.draftsCount')}</div>
          </div>
