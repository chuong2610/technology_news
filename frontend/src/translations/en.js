export const en = {
  ...
  "messages": {
    ...
    "articleAddedSuccessfully": "Article added to main collection successfully",
    "failedToAddArticle": "Failed to add article to main collection",
    "pendingArticleDeleted": "Pending article deleted successfully",
    "failedToDeletePendingArticle": "Failed to delete pending article",
    "articleCreatedFromEdit": "Article created successfully from edited content",
    "failedToCreateFromEdit": "Failed to create article from edited content",
    "articleCreatedAndDeleted": "Article created successfully and removed from pending list",
    "failedToDeleteAfterCreate": "Article created but failed to remove from pending list",
    "articleAddedAndDeleted": "Article added successfully and removed from pending list",
    "failedToDeleteAfterAdd": "Article added but failed to remove from pending list"
  },
  "myArticles": {
    "title": "My Articles",
  ...
  "scheduledArticles": {
    ...
    "add": "Add",
    "delete": "Delete",
    "addToMain": "Add to Main Articles",
    "deletePending": "Delete Pending Article",
